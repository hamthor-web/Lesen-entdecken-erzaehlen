const CACHE_NAME='lesen-entdecken-erzaehlen-v1';
const FILES=[
  './','./index.html','./geschichten.html','./finde-den-fehler.html',
  './manifest.webmanifest','./icon-192.png','./icon-512.png','./fehler-icon-512.png'
];
